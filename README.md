...
- **Arquitetura em Quatro Camadas (4-Tier)**: introdução do navegador e do servidor web, permitindo atualizações centralizadas e redução de custos operacionais.
...
Esses conceitos melhoram a manutenção, os testes e a evolução do software.
